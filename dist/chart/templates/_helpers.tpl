...
*/}}
{{- define "checkpoint-restore-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "checkpoint-restore-operator.resourceName" -}}
{{- $fullname := include "checkpoint-restore-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
{{- else }}
{{- include "checkpoint-restore-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
